...
class OperationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menu = [
            ['name' => 'Grilled Salmon', 'category' => 'Mains', 'price' => 1450, 'badge' => 'Popular', 'is_favorite' => true, 'is_bestseller' => true, 'is_vegetarian' => false, 'description' => 'Atlantic salmon with lemon butter and seasonal greens.', 'image_url' => 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=400&q=80'],
            ['name' => 'Truffle Pasta', 'category' => 'Mains', 'price' => 980, 'badge' => 'Bestseller', 'is_favorite' => true, 'is_bestseller' => true, 'is_vegetarian' => true, 'description' => 'Fettuccine tossed in silky truffle cream with cracked pepper.', 'image_url' => 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&w=400&q=80'],
            ...
            ['name' => 'Spicy Wings', 'category' => 'Appetizers', 'price' => 620, 'badge' => 'Spicy', 'is_favorite' => true, 'is_bestseller' => false, 'is_vegetarian' => false, 'description' => 'Crispy wings tossed in house buffalo sauce with ranch dip.', 'image_url' => 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?auto=format&fit=crop&w=400&q=80'],
            ...
            ['name' => 'Chocolate Lava', 'category' => 'Desserts', 'price' => 400, 'badge' => null, 'is_favorite' => true, 'is_bestseller' => false, 'is_vegetarian' => true, 'description' => 'Warm chocolate cake with a molten center and vanilla ice cream.', 'image_url' => 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=400&q=80'],
            ...
            ['name' => 'Margherita Pizza', 'category' => 'Pizza', 'price' => 890, 'badge' => 'Popular', 'is_favorite' => true, 'is_bestseller' => true, 'is_vegetarian' => true, 'description' => 'Wood-fired pizza with tomato, mozzarella, and fresh basil.', 'image_url' => 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=400&q=80'],
